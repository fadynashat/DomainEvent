...
namespace Salary.Infrastructure
{
    public class SalaryContext : DbContext, IUnitOfWork
    {
        ...
        public DbSet<Salary.Dmoain.AggregatesModel.EmployeeAggregate.Salary> Salary { get; set; }
    ...
    public class EmployeeContextDesignFactory : IDesignTimeDbContextFactory<SalaryContext>
    {
